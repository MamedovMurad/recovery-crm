        ...
        <div className="flex flex-wrap gap-3">
          {(colors || []).map((color, idx) => {
            return (
              <div
                key={idx}
                className={`${color} animate-spin inline-block w-6 h-6 border-[3px] border-current border-t-transparent rounded-full`}
                role="status"
                aria-label="loading"
              >
                <span className="sr-only">Loading...</span>
            ...
            <div className="flex">
              ...
              <div className="ms-3">
                ...
                <div className="text-sm text-sky-700 mt-2">
                  <span className="font-semibold">Holy guacamole!</span> You
  ...
  return (
    <>
      <PageBreadcrumb
        title="Spinners"
        name="Spinners"
        breadCrumbItems={["Konrix", "Components", "Spinners"]}
      />
