                ...
                <tbody>
                  {(records || []).map((record, idx) => {
                    return (
                      <tr
                        key={idx}
                        className="odd:bg-white even:bg-gray-100 dark:odd:bg-slate-700 dark:even:bg-slate-800"
                      >
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                          {record.name}
                        </td>
...
export const HoverableRows = (props: HoverableRowsProps) => {
  return (
    <div className="card">
      <div className="card-header">
              ...
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tfoot>
                  <tr>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                      <a className="text-primary hover:text-sky-700" href="">
                        Footer
                      </a>
                    </td>
                  </tr>
                    ...
                    <tr>
                      <th scope="col" className="py-3 px-4 pe-0">
                        <div className="flex items-center h-5">
                          ...
                          />
                          <label
                            htmlFor="table-search-checkbox-all"
                            className="sr-only"
                          >
                            Checkbox
                          </label>
                      ...
                      return (
                        <tr key={idx}>
                          <td className="py-3 ps-4">
                            <div className="flex items-center h-5">
                              <input
                                id="table-search-checkbox-1"
                                type="checkbox"
                                className="form-checkbox rounded"
                              />
                              <label
                                htmlFor="table-search-checkbox-1"
                                className="sr-only"
                              >
                                Checkbox
                              </label>
          ...
          <div className="min-w-full inline-block align-middle">
            <div className="border rounded-lg divide-y divide-gray-200 dark:border-gray-700 dark:divide-gray-700">
              <div className="py-3 px-4">
                <div className="relative max-w-xs">
                  <label
                    htmlFor="table-with-pagination-search"
                    className="sr-only"
                  >
                    Search
                  </label>
                    ...
                    <tr>
                      <th scope="col" className="py-3 px-4 pe-0">
                        <div className="flex items-center h-5">
                          ...
                          />
                          <label
                            htmlFor="table-pagination-checkbox-all"
                            className="sr-only"
                          >
                            Checkbox
                          </label>
                      ...
                      return (
                        <tr key={idx}>
                          <td className="py-3 ps-4">
                            <div className="flex items-center h-5">
                              <input
                                id="table-pagination-checkbox-1"
                                type="checkbox"
                                className="form-checkbox rounded"
                              />
                              <label
                                htmlFor="table-pagination-checkbox-1"
                                className="sr-only"
                              >
                                Checkbox
                              </label>
              ...
              <div className="py-1 px-4">
                <nav className="flex items-center space-x-2">
                  ...
                  <a
                    className="w-10 h-10 bg-primary text-white p-4 inline-flex items-center text-sm font-medium rounded-full"
                    href=""
                    aria-current="page"
                  >
                    1
                  ...
                  <a
                    className="w-10 h-10 text-gray-400 hover:text-primary p-4 inline-flex items-center text-sm font-medium rounded-full"
                    href=""
                  >
                    2
                  </a>
  ...
  return (
    <>
      <PageBreadcrumb
        title="Basic Table"
        name="Basic Table"
        breadCrumbItems={["Konrix", "Table", "Basic Table"]}
      />
